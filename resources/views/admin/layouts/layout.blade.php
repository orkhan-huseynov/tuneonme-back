<html>
    <head>
        ...
        <!-- Bootstrap -->
        <link href="{{URL::asset('/css/admin/vendors/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet" />
        <!-- Font Awesome -->
    ...
    <body class="nav-md">
        ...
        <!-- Bootstrap -->
        <script src="{{URL::asset('js/admin/vendors/bootstrap/dist/js/bootstrap.min.js')}}"></script>
        <!-- FastClick -->

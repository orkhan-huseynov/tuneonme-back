        ...
        <header class="gradient_background">
            <div class="container-fluid wrapper_container" id="app">
                <div class="row header__top_row">
                    ...
                    <div class="col-xs-3">
                        @if (Auth::guest())
                        <a class="btn btn-success header__top_row__btn" href="{{url('/register')}}" role="button">Sign Up</a>
                        @else
                        <a class="btn btn-success header__top_row__btn" href="{{ route('logout') }}" role="button" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign Out</a>
